...
function script.windowDisplay()
    ...
    local baseColor = rgbm(1, 1, 1, 1)  -- Biały kolor dla tekstów
    local highlightColor = rgbm(0, 1, 0, 1)  -- Zielony kolor dla dobrych wyników
    local errorColor = rgbm(1, 0, 0, 1)  -- Czerwony dla błędów

    -- Przykładowa zmiana wyświetlania kombosa
